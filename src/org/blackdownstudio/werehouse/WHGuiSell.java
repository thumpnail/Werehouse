...
class WHGuiSell {
	 ...
	 */
	public void SellGui() throws IOException {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WHGuiSell sellWindow = new WHGuiSell();
					sellWindow.frmWarehousesSell.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public void initialize() {
		...
		frmWarehousesSell = new JFrame();
		frmWarehousesSell.setType(Type.NORMAL);
		frmWarehousesSell.setTitle("Sell");
		frmWarehousesSell.setBounds(325, 618, 175, 190);
		frmWarehousesSell.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frmWarehousesSell.getContentPane().setLayout(null);
		frmWarehousesSell.setAlwaysOnTop(true);
		...
		frmWarehousesSell.getContentPane().add(comboBoxAt);
		...
		frmWarehousesSell.getContentPane().add(comboBoxProduct);
		...
		frmWarehousesSell.getContentPane().add(comboBoxAmount);
		
		JButton btnBuy_1 = new JButton("Sell");
		btnBuy_1.setBounds(10, 114, 65, 63);
		frmWarehousesSell.getContentPane().add(btnBuy_1);
		...
		frmWarehousesSell.getContentPane().add(btnOK_2);
